...
def insert_test_data():
    with app.app_context():
        # Insert test books
        book1 = Books(title="To Kill a Mockingbird", author="Harper Lee", year_published=1960, category="Fiction",
              book_type=1, book_status="Available", photo_url="static/images/bookcover.jpg",
              description="A compelling novel that addresses racial injustice and moral growth in the American South.")
        book2 = Books(title="1984", author="George Orwell", year_published=1949, category="Dystopian",
                    book_type=2, book_status="On_loan", photo_url="static/images/bookcover.jpg",
                    description="A dystopian masterpiece that explores the dangers of totalitarianism and mass surveillance.")
        book3 = Books(title="Pride and Prejudice", author="Jane Austen", year_published=1813, category="Romance",
                    book_type=3, book_status="Unavailable", photo_url="static/images/bookcover.jpg",
                    description="Jane Austen's classic novel of manners, love, and social expectations in early 19th-century England.")
        book4 = Books(title="The Great Gatsby", author="F. Scott Fitzgerald", year_published=1925, category="Classic",
                    book_type=1, book_status="Available", photo_url="static/images/bookcover.jpg",
                    description="F. Scott Fitzgerald's iconic portrayal of the Roaring Twenties, exploring themes of wealth, love, and excess.")
        book5 = Books(title="One Hundred Years of Solitude", author="Gabriel García Márquez", year_published=1967, category="Magical Realism",
                    book_type=2, book_status="On_loan", photo_url="static/images/bookcover.jpg",
                    description="A landmark of magical realism, Márquez's novel chronicles the Buendía family through generations in the fictional town of Macondo.")
        book6 = Books(title="The Hobbit", author="J.R.R. Tolkien", year_published=1937, category="Fantasy",
                    book_type=3, book_status="Available", photo_url="static/images/static/images/bookcover.jpg",
                    description="Tolkien's delightful adventure of Bilbo Baggins as he sets out on a quest with dwarves to reclaim a dragon-guarded treasure.")
        book7 = Books(title="The Catcher in the Rye", author="J.D. Salinger", year_published=1951, category="Coming of Age",
                    book_type=1, book_status="On_loan", photo_url="static/images/static/images/bookcover.jpg",
                    description="Salinger's classic novel following the teenage angst and journey of Holden Caulfield in New York City.")
        book8 = Books(title="War and Peace", author="Leo Tolstoy", year_published=1869, category="Historical Fiction",
                    book_type=2, book_status="Unavailable", photo_url="static/images/static/images/bookcover.jpg",
                    description="Tolstoy's epic masterpiece set against the backdrop of the Napoleonic Wars, exploring themes of history, love, and human nature.")
        book9 = Books(title="The Chronicles of Narnia: The Lion, the Witch and the Wardrobe", author="C.S. Lewis", year_published=1950, category="Children's Literature",
                    book_type=3, book_status="Available", photo_url="static/images/bookcover.jpg",
                    description="The enchanting first book in C.S. Lewis's Narnia series, transporting readers to a magical world of talking animals and epic adventures.")
        book10 = Books(title="The Da Vinci Code", author="Dan Brown", year_published=2003, category="Mystery",
                    book_type=1, book_status="On_loan", photo_url="static/images/bookcover.jpg",
                    description="Dan Brown's gripping mystery thriller unraveling secrets and conspiracies related to art, religion, and history.")
        book11 = Books(title="Crime and Punishment", author="Fyodor Dostoevsky", year_published=1866, category="Psychological Fiction",
                    book_type=2, book_status="Unavailable", photo_url="static/images/bookcover.jpg",
                    description="Dostoevsky's psychological exploration of crime, guilt, and redemption in 19th-century St. Petersburg.")
        book12 = Books(title="Harry Potter and the Sorcerer's Stone", author="J.K. Rowling", year_published=1997, category="Young Adult",
                    book_type=3, book_status="Available", photo_url="static/images/bookcover.jpg",
                    description="The magical beginning of J.K. Rowling's beloved Harry Potter series, introducing readers to the wizarding world.")
        book13 = Books(title="The Lord of the Rings", author="J.R.R. Tolkien", year_published=1954, category="High Fantasy",
                    book_type=1, book_status="On_loan", photo_url="static/images/bookcover.jpg",
                    description="Tolkien's epic fantasy trilogy following the quest to destroy the One Ring and save Middle-earth from the dark lord Sauron.")
        book14 = Books(title="Anna Karenina", author="Leo Tolstoy", year_published=1877, category="Romantic Novel",
                    book_type=2, book_status="Available", photo_url="static/images/bookcover.jpg",
                    description="Tolstoy's tragic tale of love, morality, and societal expectations set in 19th-century Russia.")
        book15 = Books(title="The Shining", author="Stephen King", year_published=1977, category="Horror",
                    book_type=3, book_status="On_loan", photo_url="static/images/bookcover.jpg",
                    description="Stephen King's chilling masterpiece portraying a family's descent into madness at the haunted Overlook Hotel.")
        book16 = Books(title="Lonesome Dove", author="Larry McMurtry", year_published=1985, category="Western",
                    book_type=2, book_status="Available", photo_url="static/images/bookcover.jpg",
                    description="A Pulitzer Prize-winning western novel following the epic cattle drive of two retired Texas Rangers.")
        book17 = Books(title="The Picture of Dorian Gray", author="Oscar Wilde", year_published=1890, category="Gothic Fiction",
                    book_type=2, book_status="Unavailable", photo_url="static/images/bookcover.jpg",
                    description="Wilde's classic novel exploring the consequences of hedonism and the pursuit of eternal youth.")
        book18 = Books(title="Brave New World", author="Aldous Huxley", year_published=1932, category="Science Fiction",
                    book_type=3, book_status="Available", photo_url="static/images/bookcover.jpg",
                    description="A dystopian vision of a future society controlled by technology, conditioning, and a rigid caste system.")
        book19 = Books(title="The Jungle Book", author="Rudyard Kipling", year_published=1894, category="Children's Literature",
                    book_type=1, book_status="On_loan", photo_url="static/images/bookcover.jpg",
                    description="Kipling's beloved collection of stories featuring Mowgli, a young boy raised by wolves in the Indian jungle.")
        book20 = Books(title="The Hunchback of Notre-Dame", author="Victor Hugo", year_published=1831, category="Gothic Novel",
                    book_type=2, book_status="Unavailable", photo_url="static/images/bookcover.jpg",
                    description="Hugo's Gothic novel set in medieval Paris, centered around the tragic tale of the hunchbacked bell ringer Quasimodo.")
